...
def _system_prompt() -> str:
    return (
        ...
        "and produce the corrected full journal snapshot for the active session in note.content. "
        "In context mode: remove duplicates, prefer explicit corrections "
        "(example: 'last five ... no last three' => keep only 'last three'), "
        "and keep chronological lab-relevant statements. "
